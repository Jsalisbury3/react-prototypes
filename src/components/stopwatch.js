        ...
        return (
            <div className = 'jumbotron'>
                ...
                <p className = 'text-center'>
                    ...
                    <button className = 'btn-outline-danger btn mx-3'onClick={this.stop}>Stop</button>
                    <button className = 'btn-outline-warning btn mx-3'onClick={this.reset}>Reset</button>
                </p>
            </div>
        )
    }
